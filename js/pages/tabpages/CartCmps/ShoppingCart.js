    ...
    return (
      <View style={styles.cellStyle}>
        <TouchableOpacity onPress={() => this.checkItem(sectionIndex, index)}>
          <Image style={styles.checkBox} source={statusItem.checked ? require('../../../../assest/ic_selected.png') : require('../../../../assest/ic_defult.png')} resizeMode={'center'}/>
        </TouchableOpacity>
    ...
    return (
      <View style={styles.sectionHeader}>
        <TouchableOpacity onPress={() => this.checkedShop(index)}>
          <Image style={styles.checkBox} source={shop.checked ? require('../../../../assest/ic_selected.png') : require('../../../../assest/ic_defult.png')} resizeMode={'center'}/>
        </TouchableOpacity>
        ...
        <View style={styles.toolBar}>
          <View style={{flex: 1, flexDirection: commonStyle.row, alignItems: commonStyle.center}}>
            <TouchableOpacity onPress={() => this.checkAllShop()}>
              <Image style={styles.checkBox} source={this.state.isSelectedAllItem ? require('../../../../assest/ic_selected.png') : require('../../../../assest/ic_defult.png')} resizeMode={'center'}/>
            </TouchableOpacity>
            <Text>全选</Text>
          </View>
